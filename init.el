...
(custom-set-variables
 ...
 '(package-selected-packages
   '(powerline org-journal org-super-agenda org-agenda-property yaml-mode docker all-the-icons ## which-key pdf-tools auto-complete smart-mode-line terraform-mode cyberpunk-theme imenu-list-minor-m$
	       (custom-set-faces))))
(custom-set-faces
